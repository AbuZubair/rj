<form method="post" action="{{ route('ret.crud',isset($data)?1:0 ) }}" data-redirect="{{ route('ret') }}" autocomplete="off" class="form-horizontal form-admin">
  @csrf
    ...
    <div class="card-body ">
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          <label class="col-sm-6 col-form-label">{{ __('Purchase Order Return No.') }}</label>
          <div class="col-sm-12">
          ...
          <div class="card">
            ...
            <div class="card-body p-4 table-responsive">
              <table class="table item-table">
                <thead>
                  <tr class="justify-content-between align-items-center border w-100 d-none">
