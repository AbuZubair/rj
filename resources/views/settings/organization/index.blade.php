@extends('layouts.admin', ['activePage' => 'organisasi', 'titlePage' => __('Organisasi')])
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12" style="overflow-x:auto !important">
          ...
          <form class="searchForm">
            <div class="card-body row">
              <div class="col-sm-12 col-md-6 align-items-center">
                <label class="col-sm-12 col-form-label">{{ __('Parameter') }}</label>
                <div class="col-sm-12">
        ...
        <table id="dynamic-table" class="table yajra-datatable" delete-url="{{url('settings/organisasi/delete')}}" edit-url="{{url('settings/organisasi/edit')}}" data-modal="organisasiModal" data-checkbox="organisasis">
            <thead>
                <tr>
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
    ...
    $('#searchParameter').select2();

    $('#searchParameter').on('change', function() {
      search();
    });
    ...
    tbl = $('.yajra-datatable').DataTable({
        ...
        ajax: {
            ...
            data: function ( d ) {        
              d.param = $('select[name=searchParameter]').val();
            }, 
            type: 'GET',
        },
        columns: [
