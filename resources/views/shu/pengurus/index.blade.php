@extends('layouts.admin', ['activePage' => 'shu_pengurus', 'titlePage' => __('SHU Pengurus')])
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
    ...
    table = $('.yajra-datatable').DataTable({
        ...
        columns: [
            ...
            {data: 'jumlah', render:function(data,type,full,meta){
        ...
        drawCallback: function (settings) {
            ...
            api.column(groupCol, {
                ...
                if(i==length-1){
                  var html = "<tr class='grandTotal'><td colspan='5'>Grand Total : </td></tr>"
            ...
            $('#dynamic-table tbody').find('.grandTotal').each(function (i, v) { 
                var TotalInfo = "";                          
                TotalInfo += "<td class='groupTDTot'>" + formatCurrency(grandTotal.jumlah.toFixed(2)) + "</td>"; 
  ...
  function getYearList() {
    ...
    for(var i=2016;i<=year;i++){
      ...
      $('#searchYear').select2().val(year).trigger('change');
    }
