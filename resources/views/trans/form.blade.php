<form method="post" action="{{ route('trans.crud',isset($data)?1:0 ) }}" data-redirect="{{ route('trans') }}" autocomplete="off" class="form-horizontal form-admin" id="form-trans">
  @csrf
    ...
    <div class="card-body ">
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          <label class="col-sm-6 col-form-label">{{ __('Transaksi') }}</label>
          <div class="col-sm-12">
            <div class="form-group">                      
              <select class="form-control prevent-edit" name="trans_type" id="trans_type" value="{{ old('trans_type', isset($data) ? $data['trans_type'] : '') }}" required>
                <option value="" disabled selected>Select your option</option>
                  @if(!in_array(Auth::user()->getRole(),['4']))
                    <option value="murabahah">Piutang Kredit</option>                  
                    <option value="other">Lainnya</option>
                  @endif  
                  <option value="konsinasi">Konsinasi Warung</option>
              </select>
            </div>
          </div>
        </div> 
      ...
      <div class="main-section" style="display:none">
        ...
        <div class="form-row">
          <div class="form-group col list-murabahah">
            <label class="col-sm-6 col-form-label">{{ __('Kredit Anggota*') }}</label>
            <div class="col-sm-12">
              <div class="form-group">
                <select class="form-control prevent-edit" name="no_murabahah" id="no_murabahah">
                  <option value="" disabled selected>Select your option</option>
                </select>
              </div>
            </div>
          </div>
          <div class="form-group col list-anggota">
        ...
        <div class="form-row single_coa">
          <div class="form-group col-md-6">
            ...
            <div class="col-sm-12">
              <div class="form-group">                      
                <select class="form-control" name="dk" id="dk" value="{{ old('dk', isset($data) ? $data['dk'] : '') }}" required>
                  <option value="" disabled selected>Select your option</option>
          ...
          <div class="form-group col-md-6">
            ...
            <div class="col-sm-12">
              <div class="form-group{{ $errors->has('coa_code') ? ' has-danger' : '' }}">
                <select class="form-control {{ $errors->has('coa_code') ? ' is-invalid' : '' }}" name="coa_code" id="coa_code" required>
                  <option value="" disabled selected>Select your option</option>
                </select>
              </div>
            </div>
        ...
        <div class="form-row double_coa">
          <div class="form-group col-md-6">
            ...
            <div class="col-sm-12">
              <div class="form-group{{ $errors->has('coa_code_kredit') ? ' has-danger' : '' }}">
                <select class="form-control {{ $errors->has('coa_code_kredit') ? ' is-invalid' : '' }}" name="coa_code_kredit" id="coa_code_kredit" required>
                  <option value="" disabled selected>Select your option</option>
                </select>
              </div>
            </div>
          ...
          <div class="form-group col-md-6">
            ...
            <div class="col-sm-12">
              <div class="form-group{{ $errors->has('coa_code_debit') ? ' has-danger' : '' }}">
                <select class="form-control {{ $errors->has('coa_code_debit') ? ' is-invalid' : '' }}" name="coa_code_debit" id="coa_code_debit" required>
                  <option value="" disabled selected>Select your option</option>
                </select>
              </div>
            </div>
