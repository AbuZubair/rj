<form method="post" action="{{ route('pengajuan.crud',isset($data)?1:0 ) }}" data-redirect="{{ route('pengajuan') }}" autocomplete="off" class="form-horizontal form-admin">
  @csrf
    ...
    <div class="card-body ">
      ...
      <div class="form-row">
        <div class="form-group col-md-12">
          <label class="col-sm-6 col-form-label">{{ __('Detail Uraian') }}</label>
          <div class="col-sm-12">
